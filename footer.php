<footer class="bg-gray-900 text-gray-300 mt-16">
    <div class="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <h3 class="text-white font-semibold mt-4 mb-2">Follow Us</h3>
            <div class="flex space-x-3 text-sm">
                <a href="#" class="hover:text-white" aria-label="Twitter">Twitter</a>
                <a href="#" class="hover:text-white" aria-label="Facebook">Facebook</a>
            </div>
        </div>
    </div>
